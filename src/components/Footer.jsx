          ...
          <div className="w-full xl:px-4 sm:w-1/2 lg:w-3/12 pl-0 xl:pl-12">
            <div className="w-full mb-10">
              ...
              <div className="flex items-center mb-6 gap-4">
                <Link href="javascript:void(0)" className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
