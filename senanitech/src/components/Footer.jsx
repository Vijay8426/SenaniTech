...
const Footer = () => {
  return (
    <footer className="relative  bg-white dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20 px-10 z-30">
       ...
       <div className="flex flex-wrap ">
          <div className="w-full  sm:w-2/3 lg:w-4/12  xl:pl-16">
             <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color dark:text-dark-6 mb-7 w-2/3">
          ...
          <div className="w-full xl:px-4 sm:w-1/2 lg:w-2/12">
             <div className="w-full mb-10">
                ...
                <ul className="space-y-2">
                   <li>
                      <Link href="javascript:void(0)" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6">PCB Design</Link>
                   </li>
                   <li>
                      <Link href="javascript:void(0)" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6">Production Engineering</Link>
                   </li>
                   <li>
                      <Link href="javascript:void(0)" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6">Manufacturing Support</Link>
                   </li>
          ...
          <div className="w-full xl:px-4 sm:w-1/2 lg:w-3/12">
             <div className="w-full mb-10">
                ...
                <div className="flex items-center mb-6 gap-4">
                   <Link href="javascript:void(0)" className="flex items-center justify-center w-8 h-8 mr-3 border rounded-full text-dark hover:border-primary hover:bg-primary border-stroke dark:border-dark-3 dark:hover:border-primary dark:text-white hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
